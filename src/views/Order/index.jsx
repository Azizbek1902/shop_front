    ...
    <>
      <div className="menu_order">
        <div
          ...
          onClick={() => getOrder({ status: 0, date: moment(dateValue).format("YYYY-MM-DD") })}
        >
          Yangi
        ...
        <div
          ...
          onClick={() => getOrder({ status: 1, date: moment(dateValue).format("YYYY-MM-DD") })}
        >
          Tayyorlanmoqda
        ...
        <div
          ...
          onClick={() => getOrder({ status: 2, date: moment(dateValue).format("YYYY-MM-DD") })}
        >
          Jo'natildi
        ...
        <div
          ...
          onClick={() => getOrder({ status: 3, date: moment(dateValue).format("YYYY-MM-DD") })}
        >
          Yetkazildi
        ...
        <div
          ...
          onClick={() => getOrder({ status: 4, date: moment(dateValue).format("YYYY-MM-DD") })}
        >
          Bekor qilindi
